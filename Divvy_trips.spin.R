...
setwd("/Users/adityakapur/Downloads/study material google/case study 1 cyclistic") #sets your working directory to simplify calls to data ... make sure to use your OWN username instead of mine ;)
...
all_trips <- mutate(all_trips, ride_length = difftime(ended_at, started_at))
...
write.csv(counts, file = "/Users/adityakapur/Downloads/study material google/case study 1 cyclistic/avg_ride_length.csv")
